class Snipp < ActiveRecord::Base
  ...
  def self.html_tags
    tags = %w(a acronym b strong i em li ul ol h1 h2 h3 h4 h5 h6 hr blockquote br cite sub sup ins p div button textarea input form span select option fieldset legend label img section for table thead tbody tr th td)
  end
